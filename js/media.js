...
const I18N_EXTRA = {
  ko:{
    "hero.kicker":"ASIA 인플루언스 네트워크",
    "reel.title":"지금 가장 뜨거운 콘텐츠","reel.sub":"풀 소속 크리에이터의 대표 영상이 실시간으로 재생됩니다.",
    "net.title":"아시아 전역을 어우르는 네트워크","net.sub":"동남아를 거점으로 한·중·일까지, 아시아 전역의 인플루언서를 연결합니다.",
  ...
  en:{
    ...
    "net.title":"A network spanning all of Asia","net.sub":"From a Southeast Asian base across to Korea, China and Japan — influencers connected Asia-wide.",
  ...
  vi:{
    ...
    "net.title":"Mạng lưới phủ khắp châu Á","net.sub":"Từ Đông Nam Á tới Hàn, Trung, Nhật — kết nối influencer toàn châu Á.",
  ...
  th:{
    "hero.kicker":"เครือข่ายอินฟลูเอนซ์แห่งเอเชีย",
    "reel.title":"คอนเทนต์มาแรงตอนนี้","reel.sub":"วิดีโอเด่นจากครีเอเตอร์ของเรา เล่นแบบเรียลไทม์",
    "net.title":"เครือข่ายครอบคลุมทั่วเอเชีย","net.sub":"จากเอเชียตะวันออกเฉียงใต้ถึงเกาหลี จีน ญี่ปุ่น เชื่อมอินฟลูเอนเซอร์ทั่วเอเชีย",
  ...
  id:{
    "hero.kicker":"JARINGAN PENGARUH ASIA",
    "reel.title":"Konten paling hot saat ini","reel.sub":"Video unggulan dari roster kami, tayang langsung.",
    "net.title":"Jaringan yang mencakup seluruh Asia","net.sub":"Dari Asia Tenggara hingga Korea, China, Jepang — influencer terhubung se-Asia.",
  ...
  zh:{
    ...
    "net.title":"覆盖全亚洲的网络","net.sub":"以东南亚为据点，延伸至韩中日——连接全亚洲的网红。",
    "net.count":"个国家的网络",
